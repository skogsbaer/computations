...
module Control.Computations.Demos.Hospital.Simulation (
  SimCfg (..),
  defaultSimCfg,
  SimArgs (..),
  defaultSimArgs,
...
import qualified Control.Computations.Demos.Hospital.FakeDiagnoses as Fake
import qualified Control.Computations.Demos.Hospital.FakeWords as Fake
