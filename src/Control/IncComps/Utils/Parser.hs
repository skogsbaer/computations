...
test_stringLiteralP =
    do subAssert $ testParser "\"*\"" stringLiteralP "*"
...
test_intP :: IO ()
test_intP =
    do subAssert $ testParser "100 " intP 100
...
test_floatP :: IO ()
test_floatP =
    do subAssert $ testParser "100.00 " floatP (100.0 :: Double)
...
test_boolP :: IO ()
test_boolP =
    do subAssert $ testParser "True " boolP True
...
test_listP :: IO ()
test_listP =
    do subAssert $ testParser "[   ]   " (listP stringLiteralP) []
       subAssert $ testParser "[ \"hello\"  , \"world\"  ]"
           (listP stringLiteralP) ["hello", "world"]
...
test_record2P :: IO ()
test_record2P =
    do subAssert $ testParser "Person {  name= \"Stefan\"  ,   age = 38 } "
...
test_optional :: IO ()
test_optional =
    do subAssert $ testParser "" (optionalP def (return 2)) 2
